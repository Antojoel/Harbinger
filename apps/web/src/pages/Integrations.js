...
import { Plug, Terminal, Copy, Mic, Square, Volume2 } from "lucide-react";
  ...
  return (
    <Card className="p-5">
      ...
      <p className="mb-4 text-xs text-muted-foreground">
        ...
        <code className="rounded bg-muted px-1">POST /api/voice-query</code>, and plays
      ...
      {isTextOnly ? (
        <div className="mb-4 flex items-center gap-3">
          <input
            className="flex h-9 w-full max-w-md rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-sm"
            value={textQuestion}
      ...
      <div className="mb-4 rounded-lg border bg-muted/30 p-3 text-xs text-muted-foreground">
        <div className="mb-1 font-medium text-foreground">Mic &amp; speaker permissions</div>
        <ul className="list-disc space-y-1 pl-4">
          <li>
            ...
            <code className="mx-1 rounded bg-muted px-1">localhost</code>
          ...
          <li>
            ...
            <code className="mx-1 rounded bg-muted px-1">&lt;audio&gt;</code> element. Playback
          ...
          <li>
            ...
            <code className="mx-1 rounded bg-muted px-1">response_text</code> is worded.
      ...
      {result && (
        <div className="space-y-2 rounded-lg border bg-muted/30 p-3 text-sm">
          <div>
            ...
            <span className="text-muted-foreground">{result.transcript || "(empty — text_only or STT failed)"}</span>
          </div>
          <div>
      ...
      <p className="mt-3 text-[11px] text-muted-foreground">
        ...
        <code className="rounded bg-muted px-1">MSKU1234567</code>, or record an outcome for
